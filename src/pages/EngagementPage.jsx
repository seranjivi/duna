          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold text-blue-100 mb-5">
                <Users className="h-3.5 w-3.5 text-cyan-300" /> Section 03 — Engagement & Profile
              </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/65 md:text-base">
                  Database optimization, Python automation, GenAI integration, PHP backend, or legacy
                  system support — let's explore how this expertise delivers value for your team.
                </p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
                ...
                <div className="flex flex-wrap gap-3">
                  {[{ label: "Database Skills", page: "DatabasePage" }, { label: "Automation & AI", page: "AutomationAIPage" }].map((l) => (
                    <button key={l.page} onClick={() => onNavigate && onNavigate(l.page)} className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium text-white hover:bg-white/20 transition whitespace-nowrap">
